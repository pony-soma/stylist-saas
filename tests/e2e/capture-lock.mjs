...
try {
  ...
  console.log('Scope: standard/signed upload, delete, login. In-flight/resumable/S3 uploads, hosted service versions, sequences and cutover remain separate gates.');
} catch {
