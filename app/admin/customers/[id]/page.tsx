            ...
            <div className="flex flex-wrap gap-3 mb-4">
              ...
              <div className="w-[135px] shrink-0">
                ...
                <input
                  ...
                  className="w-full bg-gray-50 dark:bg-slate-800/50 border border-gray-200 dark:border-gray-700 rounded-xl px-2 py-2.5 text-sm text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition"
                />
              </div>
              ...
              <div className="w-16 shrink-0">
                ...
                <div className="w-full bg-gray-100 dark:bg-slate-800 border border-transparent rounded-xl px-1 py-2.5 text-sm text-gray-500 dark:text-gray-400 text-center font-medium whitespace-nowrap">
                  {(() => {
              ...
              {/* 性別 */}
              <div className="flex-1 min-w-[90px] sm:w-28 sm:flex-none shrink-0">
                ...
                <select
                  ...
                  onBlur={handleSaveProfile}
                  className="w-full bg-gray-50 dark:bg-slate-800/50 border border-gray-200 dark:border-gray-700 rounded-xl px-2 py-2.5 text-sm text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition appearance-none"
                >
