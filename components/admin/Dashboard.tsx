    ...
    <div className="p-6 max-w-6xl mx-auto space-y-8 animate-in fade-in duration-500">
      <header className="flex flex-col gap-4 sm:gap-5 pb-5 border-b border-gray-200 dark:border-gray-800">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          ...
          {/* 予約URLボックス */}
          {userId && (
            <div className="w-full md:w-auto text-left md:text-right mt-1 md:mt-0 p-3 md:p-0 bg-indigo-50/50 md:bg-transparent dark:bg-indigo-900/10 md:dark:bg-transparent rounded-xl md:rounded-none border md:border-none border-indigo-100 dark:border-indigo-800/30">
              <p className="text-[11px] sm:text-xs text-indigo-600 dark:text-indigo-400 font-bold mb-2 md:mb-1">あなた専用の予約URL（LINEに設定）</p>
              <div className="flex md:justify-end">
                <button
                  className="w-full md:w-auto justify-center whitespace-nowrap text-xs bg-indigo-600 hover:bg-indigo-700 text-white dark:bg-indigo-500 dark:hover:bg-indigo-600 px-4 py-2.5 md:py-1.5 rounded-lg flex items-center gap-1.5 transition-colors font-bold shadow-sm"
                  onClick={() => {
